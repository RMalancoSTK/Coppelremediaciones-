$(document).ready(function () {
  ...
  $(".editar").click(function () {
    ...
    $(".editar_estatus_" + id).html(
      '<select name="guardar_estatus_' +
        id +
        '" class="guardar_estatus_' +
        id +
        '"> <option value="1" ' +
        activo +
  ...
  $(".save").click(function () {
    ...
    if (html_pat == "") {
      $(".mensaje_sistema").html(
        "El campo apellido paterno no puede estar vacio"
      );
      $(".mensaje").addClass("bg-warning");
      $("#mensajeModal").modal("show");
      exit();
    ...
    if (html_mat == "") {
      $(".mensaje_sistema").html(
        "El campo apellido materno no puede estar vacio"
      );
      $(".mensaje").addClass("bg-warning");
      $("#mensajeModal").modal("show");
      exit();
